                  ...
                  <div>
                    <div className="row">
                      <div className="col-md-4">
                        <Link to="/">
                        <img src="img/about/Jerome Escultura.png" alt="" className="img-responsive"/>
                        </Link>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-md-3">
                        ...
                        <ul>
                          ...
                          <li>Develop in an Agile environment (SCRUM) - Be Agile, Be Lean, MVP vs Perfection.</li>
                  ...
                  <div className="about-container">
                    <div className="row">
                      <div className="col-md-6">
                        <img src="img/about/youth.png" className="img-responsive" alt="" />
                      </div>
                      <div className="col-md-5 offset-1">
                        <div className="text">
                          <h2>Volunteer Works</h2>
                          <p>Children International is an International Non-government organization aim to create a world without poverty where every child, family and community is connected, productive and thriving.</p>
                            <ul className="links">
                              <li><a rel="noopener noreferrer" target="_blank"   href="https://www.children.org/">Children International</a>
                              </li>
                              <li><a rel="noopener noreferrer" target="_blank"   href="https://www.peacecorps.gov/philippines/">Peace Corps in Philippines</a>
                              </li>
                            </ul>
                        </div>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <p>Oversees the duties and functions for both Agency Level and Center level Youth Council. Serves as the head of the Core Group in <a href="https://www.children.org/" rel="noopener noreferrer" target="_blank">Children International</a>.</p>
                        <p>Represents the Youth Council and its programs by serving as member of the Agency’s Board of Trustees (BOT) during my term of office.</p>
                        <p>Actively presides meetings and prepares agenda for the Core Group to be disseminated through the Agency Youth Council Vice President for Monitoring and Evaluation.</p>
                      </div>
                      <div className="col-md-6">
