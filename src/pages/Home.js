    ...
    projects: [
      {
        ...
        desc2: 'It enhance the way kids read books, using the latest technology of AR and 3D models, Story books can transform into interactive materials and help the kids to deeply understand the story.',
        desc3: 'Booklandia aim to enhance the kids reads books and encourage them to read more, by developing an application that can run both android and IOS platform, Booklandia will educate and entertain kids by importing virtual world into real world.',
      ...
      },
      {
        ...
        category: 'Design',
        url: '',
        desc1: 'The FAMRUN project purpose of this project is to strengthen the relationship of the families in the community and encourage them to start the prevention and education about the detrimental effect of abusing drugs. FAMRUN project will help the community of Bagong Silang to strive in eradicating drug addiction through strengthening family relationships. Also, it will make our community advocates of the illegal drug free community.',
        desc2: 'The event will not only bring more effective partnership within the community of Bagong Silang but also ignite the cooperation of community people to solve more pressing issues aside from drugs. Fam Run project is a second version of the 2017 SCP FunRun project which aimed to increase awareness in illegal drugs. This year, incorporating the essence of family, the FamRun will focus on family empowerment through a run and interactive activities as a start in building good family relations.',
      ...
      },
      {
        ...
        category: 'Design',
        url: '',
        desc1: 'The K to 12 Program covers Kindergarten and 12 years of basic education (six years of primary education, four years of Junior High School, and two years of Senior High School [SHS]) to provide sufficient time for mastery of concepts and skills, develop lifelong learners, and prepare graduates for tertiary education, middle-level skills development, employment, and entrepreneurship.',
        desc2: 'Its a new curriculum in the Philippines, together with Children International Inc, We created Infographics that helps the community to be familiar with K12 Program.',
      ...
      },
      {
        ...
        category: 'Design',
        url: '',
        desc1: 'Aloha design is used during the Procter & Gamble company event in the Philippines.',
